...
public class PostsSqlImpl extends JanglesSql implements PostsSql {

    IConnection iConnection;

    private static final Logger logger = LoggerFactory.getLogger(PostsSqlImpl.class);


    @Inject
    public PostsSqlImpl(IConnection iConnection) {
        super(iConnection);
    }
